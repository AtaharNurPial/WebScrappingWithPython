...
def pageCrawler(sauce):
    pages = sauce.find('div', class_ = 'srp-pagination clearfix')
    if not pages.find('em', class_ = 'nxtC'):
        url = 'https://www.timesjobs.com' + str(pages.find('div', class_ = 'srp-pagination clearfix').find_all('em').a['href'])
        return url
    else:
        return
